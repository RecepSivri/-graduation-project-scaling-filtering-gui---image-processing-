...
public class And extends Logical {
    ...
    public BufferedImage returnlogicalResult() {
        if (getInput1().getData().getNumBands() == 3 && getInput1().getData().getNumBands() == 3) {
            ...
            for (int i = 0; i < result.getHeight(); ++i) {
                for (int j = 0; j < result.getWidth(); ++j) {
                    ...
                    if (c1.getRed() == 255 && c2.getRed() == 255)
                        red = 255;
                    else if (c1.getRed() == 255)
                        red = c2.getRed();
                    else if (c2.getRed() == 255)
                        red = c1.getRed();
                    ...
                    if (c1.getGreen() == 255 && c2.getGreen() == 255)
                        red = 255;
                    else if (c1.getGreen() == 255)
                        green = c2.getGreen();
                    else if (c2.getGreen() == 255)
                        green = c1.getGreen();
                    ...
                    if (c1.getBlue() == 255 && c2.getBlue() == 255)
                        blue = 255;
                    else if (c1.getBlue() == 255)
                        blue = c2.getBlue();
                    else if (c2.getBlue() == 255)
                        blue = c1.getBlue();
            ...
            return result;
        } else if (getInput1().getData().getNumBands() == 1 && getInput1().getData().getNumBands() == 1) {
            BufferedImage MaxImage = returnMaxSizedImage();
            ...
            for (int i = 0; i < result.getHeight(); ++i) {
                for (int j = 0; j < result.getWidth(); ++j) {
                    ...
                    else if (MaxImage.getRGB(j,i) == 16777216)
                        LogicResult = MaxImage2.getRGB(j,i);
                    else if (MaxImage2.getRGB(j,i) == 16777216)
